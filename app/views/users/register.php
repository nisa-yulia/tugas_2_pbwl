            ...
            <div class="card-body">
                <form method="post" action="<?php echo URLROOT ;?>/users/register">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <input type="submit" class="btn btn-info btn-block pull-left" value="Daftar">
                            </div>
                            <div class="col">
                                <a href="<?php echo URLROOT ;?>/users/login" class="btn btn-info btn-block pull-right">Login </a>
                            </div>
                        </div>
                    </div>
                </form>
